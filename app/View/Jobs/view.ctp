<h3><?php echo $job['Job']['title']; ?> </h3>
        <ul>
            ...
            <li><strong>Contact Email: </strong><a href="<?php echo $job['Job']['contact_email'] ?>?Subject=Job%20Application" target="_top">employer@somecompany.com</a></li>
        </ul>
        <p><a href="<?php echo $this->webroot; ?>">Back To Jobs </a></p>
